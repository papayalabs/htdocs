						...
						<?php endif ;?>
							...
							<div class="wpsc_product_price">
								...
								<?php else : ?>
									...
									<?php endif; ?>
									<span id="product_price_<?php echo wpsc_the_product_id(); ?>" class="pricedisplay2"><?php echo TXT_WPSC_PRICE; ?>: <?php echo wpsc_the_product_price(); ?></span> <br/>
									<?php if(get_option('display_pnp') == 10) : ?>
										<span class="pricedisplay2"><?php echo TXT_WPSC_PNP; ?>:<?php echo wpsc_product_postage_and_packaging(); ?></span>  <br />
									<?php endif; ?>							
								<?php endif; ?>
							</div>
