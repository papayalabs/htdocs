...
define('TXT_WPSC_ADD_VAR', utf8_encode('Añadir opción'));
define('TXT_WPSC_EDIT_VAR', utf8_encode('Editar opción'));
define('TXT_WPSC_SELECTAVARIATION', utf8_encode('Seleccione una opción'));
define('TXT_WPSC_NEW_VARIATION', utf8_encode('Crear nueva opción'));
...
define('TXT_WPSC_DESCRIPTION', utf8_encode('Descripción'));
...
define('TXT_WPSC_PLEASEENTERAVALIDADDRESS', utf8_encode('Por favor introduzca una dirección v lida'));
...
define('TXT_WPSC_NUMBEROFITEMS', utf8_encode('Número de artículos'));
...
define('TXT_WPSC_YOURSHOPPINGCARTISEMPTY', utf8_encode('Su carrito de compra está vacio'));
...
define('TXT_WPSC_EMAILMSG1', "Gracias, el pedido ha sido aceptado, ser  procesado y enviado lo más pronto posible, los elementos pueden ser descargados usando los enlaces.\n\r\n\rTodos los precios incluyen tasas y gastos de envío.\n\r\n\rDetalle de tu pedido:\n\r\n\r");
...
define('TXT_WPSC_UPDATE_BUTTON', utf8_encode('Actualizar'));
define('TXT_WPSC_SELECTYOURBUSINESSLOCATION', utf8_encode('Seleccione su localizacion de negocios primario'));
define('TXT_WPSC_TAX_SETTINGS', utf8_encode('Configuracion de Impuestos'));
 
define('TXT_WPSC_CATEGORISATION', 'Categorias');
...
define('TXT_WPSC_UPDATING_CART', utf8_encode('Actualizando Carrito...'));
define('TXT_WPSC_YOU_JUST_ADDED', utf8_encode('Acaba de ser añadido "[product_name]" a su carrito de compra.'));
define('TXT_WPSC_TAX', 'I.V.A.');
define('TXT_WPSC_REVIEW_YOUR_ORDER', 'Por favor, revise su orden');
define('TXT_WPSC_ORDER_PENDING', utf8_encode('Gracias, tu compra está pendiente, se le enviará un correo electrónico una vez que la orden haya pasado.'));
define('TXT_WPSC_ORDER_PENDING_PAYMENT_REQUIRED', 'Orden Pendiente: Pago Requerido');
define('TXT_WPSC_UPGRADES_PAGE', 'Actualizaciones');
define('TXT_WPSC_MARKETING', 'Mercadeo');

define('TXT_WPSC_OPTIONS_GENERAL_HEADER', 'Opciones Generales');
define("TXT_WPSC_TM", 'Mercados Destinos');

define('TXT_WPSC_USE_SHIPPING', 'Usar Envio');
define('TXT_WPSC_USE_SHIPPING_DESCRIPTION', utf8_encode('Si solo vende descargas digitales, se deberia desabilitar en envio en su página'));
define('TXT_WPSC_REQUIRE_REGISTRATION', 'El usuario deberia registrarse antes de hacer checkout');
define('TXT_WPSC_LOCK_TAX', utf8_encode('Blockear Impuesto para el país de facturación'));
define('TXT_WPSC_SHIPPING_SAME_AS_BILLING', utf8_encode('Habilitar la opción de envio igual que la de facturación: '));
